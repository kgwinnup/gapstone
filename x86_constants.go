...
const (
	...
	//X86_SSE_CC_EQ_UQ   = C.X86_SSE_CC_EQ_UQ
	//X86_SSE_CC_NGE     = C.X86_SSE_CC_NGE
	//X86_SSE_CC_NGT     = C.X86_SSE_CC_NGT
	//X86_SSE_CC_FALSE   = C.X86_SSE_CC_FALSE
	//X86_SSE_CC_NEQ_OQ  = C.X86_SSE_CC_NEQ_OQ
	//X86_SSE_CC_GE      = C.X86_SSE_CC_GE
	//X86_SSE_CC_GT      = C.X86_SSE_CC_GT
	//X86_SSE_CC_TRUE    = C.X86_SSE_CC_TRUE
)
